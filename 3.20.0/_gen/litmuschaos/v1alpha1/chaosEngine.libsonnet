  ...
  spec: {
    ...
    components: {
      ...
      runner: {
        ...
        withRunnerLabels(runnerLabels): { spec+: { components+: { runner+: { runnerLabels: runnerLabels } } } },
        ...
        withRunnerLabelsMixin(runnerLabels): { spec+: { components+: { runner+: { runnerLabels+: runnerLabels } } } },
      ...
      withSidecar(sidecar): { spec+: { components+: { sidecar: if std.isArray(v=sidecar) then sidecar else [sidecar] } } },
      ...
      withSidecarMixin(sidecar): { spec+: { components+: { sidecar+: if std.isArray(v=sidecar) then sidecar else [sidecar] } } },
    },
    ...
    selectors: {
      ...
      withPods(pods): { spec+: { selectors+: { pods: if std.isArray(v=pods) then pods else [pods] } } },
      '#withPodsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pods', type=d.T.array)]),
      withPodsMixin(pods): { spec+: { selectors+: { pods+: if std.isArray(v=pods) then pods else [pods] } } },
      '#withWorkloads':: d.fn(help='', args=[d.arg(name='workloads', type=d.T.array)]),
      withWorkloads(workloads): { spec+: { selectors+: { workloads: if std.isArray(v=workloads) then workloads else [workloads] } } },
      ...
      withWorkloadsMixin(workloads): { spec+: { selectors+: { workloads+: if std.isArray(v=workloads) then workloads else [workloads] } } },
    ...
    withDefaultHealthCheck(defaultHealthCheck): { spec+: { defaultHealthCheck: defaultHealthCheck } },
